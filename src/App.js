  ...
  return (
    <div className="App">
        ...
        <div className='conteudo'>
          ...
          <h3>O país que virou 'lixão' de roupas usadas dos países ricos</h3>
          ...
          <div className='fontes'>
            ...
            <p>Fonte: <a href="https://revistagalileu.globo.com/Revista/noticia/2016/06/escravos-da-moda-os-bastidores-nada-bonitos-da-industria-fashion.html">https://revistagalileu.globo.com/Revista/noticia/2016/06/escravos-da-moda-os-bastidores-nada-bonitos-da-industria-fashion.html</a></p>
        ...
        <footer>
          <div>
            <p>Desenvolvido por: Grupo 5</p>
            <p>Integrantes: Kaio Vinicius de Paiva Rodrigues, Isabelle Pinto Vargas, Mylena Eduarda Vogt Stuelp, Murilo Tatsch Pereira</p>
          </div>
          <img src={img7}/>
        </footer>
    </div>
